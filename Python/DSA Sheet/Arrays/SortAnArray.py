# When it comes to sorting with O(nlogn) time complexity we can go for merge sort, heap sort or quick sort
# quick sort on worst case is O(n2) so we will approach with merge sort
